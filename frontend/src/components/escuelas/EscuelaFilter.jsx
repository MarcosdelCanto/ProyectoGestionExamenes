// src/components/escuelas/EscuelaFilter.jsx
import React from 'react';
import { Card, Form, Row, Col, Button } from 'react-bootstrap';

function EscuelaFilter({ onFilterChange, currentFilters }) {
      ...
      <Card.Body>
        <Form>
          <Row className="g-3 align-items-end">
            <Col md={8} lg={9}>
              <Form.Group controlId="filterNombreEscuela">
